        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-6">
                    ...
                    <img
                        className="col-start-2 col-end-3 max-h-24 w-full object-contain"
                        src={'images/logos/logoMercedes.png'}
                        alt="Transistor"
                        width={200}
                        height={100}
                    />
                    <img
                        ...
                        src={'images/logos/logoLamborghini.png'}
                        alt="Reform"
                        width={200}
                        height={100}
                    />
                    ...
                    <img
                        ...
                        src={'images/logos/logoPorsche.png'}
                        alt="SavvyCal"
                        width={200}
                        height={100}
                    />
